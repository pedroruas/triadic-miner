...
def triadic_miner(file_path, compute_feature_generators_for_infimum, compute_concept_stability, compute_separation_index , save_hasse_diagram, file_name):
    ...
    updated_triadic_concepts = TriadicConcept.compute_f_generators_candidates(triadic_concepts, links, compute_feature_generators_for_infimum)
    Timer.stop()
    ...
    if compute_separation_index:
        ...
        updated_triadic_concepts = TriadicConcept.separation_index_calculation(updated_triadic_concepts)
        Timer.stop()
...
def main():
    ...
    for input_file_path in data['input_files']:
        ...
        triadic_miner(input_file_path, compute_feature_generators_for_infimum, compute_concept_stability, compute_separation_index, save_hasse_diagram, file_name)
